...
#ifndef DECSCNMODEL_H_
#define DECSCNMODEL_H_
...
class DecScnModel: public SmiScnModel {
...
public:
	...
	/** copy constructor */
	DecScnModel(const DecScnModel & rhs);

	/** copy constructor */
	DecScnModel(const SmiScnModel & rhs);
