...
#ifndef DECSTOMODEL_H_
#define DECSTOMODEL_H_

#include "Model/StoModel.h"
#include "Model/DecModel.h"

#include "SmiScenarioTree.hpp"

class DecStoModel: public StoModel, public DecModel {
...
public:
	...
	/** copy constructor */
	DecStoModel(const DecStoModel & rhs);

	/** copy constructor */
	DecStoModel(const StoModel & rhs);
